...
//	'sql_error'			=> ' Error. Please perform the following update statement by hand, then re-run the upgrade program',//'出错,请手工执行以下升级语句后,再重新运行本升级程序',
	...
	'color_card'			=> '칼라카드',//'变色卡',
	'color_card_descr'		=> '게시물 혹은 일지의 제목 칼라를 변경 강조 표시 가능.',//'可以将帖子或日志的标题高亮，变更颜色',
	...
	'apps_completed'		=> '애플리케이션 통계 업그레이드 완성',//'漫游应用统计升级完成',
	'navigation_completed'		=> '네비게시션 데이터 업그레이드 완성',//'导航数据升级完成',
	'group_status_completed'	=> '포럼판 상태 업그레이드 완성.',//'版块状态升级完毕',
	'recommendations_completed'	=> '답글추천 업그레이드 완성',//'回帖推荐升级完毕',
	...
	'new_pm_completed'		=> '새 쪽지 상태 재설정 완료.',//'新短消息状态重置完毕',
...
//	'ready_to_db_upgrade'	=> '준비완료:다음 데이터뱅크 구조 업데이트 준비...',//'准备完毕，进入下一步数据库结构升级',
	...
	'group_stat_completed'	=> '포럼판 통계 테이터 업데이트 완료',//'论坛版块统计数据升级完毕',
);