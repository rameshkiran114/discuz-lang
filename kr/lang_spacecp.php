...
$lang = array(
	...
	'reward'		=> '포상',//'悬赏',
	'reward_info'		=> '투표에 참가하시면 \\1 포인트를 얻을수 있습니다.',//'参与投票可获得  \\1 积分',
	'poll_separator'	=> ', ',//'"、"',
	...
	'message_can_not_send_2'	=> '쪽지연속 발송 시간 간격 늦게 해주세요.',//'两次发送短消息太快，请稍候再发送',
	'message_can_not_send_3'	=> '죄송합니다. 친구가아닌 분에게 쪽지대량 발송이 불가합니다.',//'抱歉，您不能给非好友批量发送短消息',
	'message_can_not_send_4'	=> '죄송합니다. 님은아직 쪽지발송 기능 사용 불가합니다.',//'抱歉，您目前还不能使用发送短消息功能',
	'message_can_not_send_5'	=> '24시간내 그룹채팅 상한선을 초과 하셨습니다.',//'您超出了24小时内群聊会话的上限',
	'message_can_not_send_6'	=> '상대방이 님의 쪽지수락을 차단 하셧습니다',//'对方屏蔽了您的短消息',
	'message_can_not_send_7'	=> '그룹채팅 허용인수를 초과 하셨습니다.',//'超过了群聊人数上限',
	'message_can_not_send_8'	=> '죄송합니다. 자신에게는 쪽지 발송이 불가합니다.',//'抱歉，您不能给自己发短消息',
	'message_can_not_send_9'	=> '수신자가 없거나 상대방이 님의 쪽지수락을 차단 하셨습니다.',//'收件人为空或对方屏蔽了您的短消息',
	...
	'message_can_not_send_16'	=> '24시간내 쪽지 발송 허용수량을 초과 하셨습니다.',//'您超出了24小时内发短消息数量的上限',
	'message_can_not_send_onlyfriend'	=> '상대방은 친구 쪽지만 받습니다.',//'该用户只接收好友发送的短消息',
	...
	'comment_friend'	=> '<a href="\\2" target="_blank">\\1 님에게 쪽지를 남겼습니다.</a>',//'<a href="\\2" target="_blank">\\1 给你留言了</a>',
	...
	'friend_pm'		=> '<a href="\\2" target="_blank">\\1 님에게 비밀쪽지를 발송했습니다.</a>',//'<a href="\\2" target="_blank">\\1 给你发私信了</a>',
	...
	'friend_pm_reply'	=> '\\1 님의 비밀쪽지에 답변 하셨습니다.',//'\\1 回复了你的私信',
	'comment_friend_reply'	=> '\\1 님의 쪽지에 답변 하셨습니다.',//'\\1 回复了你的留言',
	...
	'mail_my'		=> '친구와의 연락 알림.',//'好友与我的互动提醒',
	'mail_system'		=> '시스템 알림.',//'系统提醒',
	...
	'share_blog'		=> '블로그의 한편 글을 공유 하셨습니다.',//'分享了一篇日志',
	'share_album'		=> '앨범하나를 공유 하셨습니다.',//'分享了一个相册',
	'default_albumname'	=> '기본앨범',//'默认相册',
	'share_image'		=> '이미지 한장을 공유 하셨습니다.',//'分享了一张图片',
	...
	'share_tag_blognum'	=> '지금 {blognum} 편의 일지가 있습니다.',//'现有 {blognum} 篇日志',
	'share_link'		=> '인터넷 주소를 공유 하셨습니다.',//'分享了一个网址',
	'share_video'		=> '미디어를 공유 하셨습니다.',//'分享了一个视频',
	'share_music'		=> '음악을 공유 하셨습니다.',//'分享了一个音乐',
	'share_flash'		=> 'Flash를 공유 하셨습니다.',//'分享了一个 Flash',
	...
	'take_part_in_the_voting'		=> '{actor}는 {touser}의 투표에 참가 하셨습니다. <a href="{url}" target="_blank">{subject}</a> and get reward {reward} points.',//'{actor} 参与了 {touser} 的{reward}投票 <a href="{url}" target="_blank">{subject}</a>',
	...
	'apply_mtag_manager'	=> ' <a href="\\1" target="_blank">\\2</a> 의 군주가 되길 원합니다. 그 이유는:\\3 <br><a href="\\1" target="_blank">(이곳을 체크하셔서 관리)</a>',//'想申请成为 <a href="\\1" target="_blank">\\2</a> 的群主，理由如下:\\3。<a href="\\1" target="_blank">(点击这里进入管理)</a>',


	'magicunit'		=> 'ones',//'个',
	'magic_note_wall'	=> '방명록에 <a href="{url}" target="_blank">메모 남기기</a>',//'在留言板上给你<a href="{url}" target="_blank">留言</a>',
	'magic_call'		=> '일지중에서 님의 이름이 떳습니다, <a href="{url}" target="_blank">바로보기</a>',//'在日志中点了你的名，<a href="{url}" target="_blank">快去看看吧</a>',
	...
	'do_stat_share'		=> '공유',//'分享',
	'do_stat_thread'	=> '주제',//'主题',
	'do_stat_docomment'	=> '기록답글',//'记录回复',
	'do_stat_blogcomment'	=> '일지 코멘트',//'日志评论',
	'do_stat_piccomment'	=> '이미지 코멘트',//'图片评论',
	'do_stat_pollcomment'	=> '투표 코멘트',//'投票评论',
	'do_stat_pollvote'	=> '투표 참석',//'参与投票',
	'do_stat_eventcomment'	=> '이벤트 코멘트',//'活动评论',
	'do_stat_eventjoin'	=> '이벤트 참석',//'参加活动',
	'do_stat_sharecomment'	=> '공유 코멘트',//'分享评论',
//vot	'do_stat_post'		=> 'Replies',//'主题回帖',
	'do_stat_click'		=> '정적',//'表态',
	'do_stat_wall'		=> '메세지',//'留言',
	'do_stat_poke'		=> '인사',//'打招呼',
	'do_stat_sendpm'	=> '쪽지',//'发短消息',
	'do_stat_addfriend'	=> '친구요청',//'好友请求',
	'do_stat_friend'	=> '친구되기',//'成为好友',
	'do_stat_post_number'	=> '게시글 수',//'发帖量',
	'do_stat_statistic'	=> '병합통계',//'合并统计',
	'logs_credit_update_TRC'	=> '미션 보상',//'任务奖励',
	'logs_credit_update_RTC'	=> '포상주제',//'悬赏主题',
	...
	'logs_credit_update_PRC'	=> '게시물이 평점되였음.',//'帖子被评分',
	'logs_credit_update_RSC'	=> '게시물 평점',//'帖子评分',
	'logs_credit_update_STC'	=> '주제 판매',//'出售主题',
	'logs_credit_update_BTC'	=> '주제 구매',//'购买主题',
	'logs_credit_update_AFD'	=> '포인트 구매',//'购买积分',//?????????
	'logs_credit_update_UGP'	=> '확장 사용자 그룹 구매',//'购买扩展用户组',
	'logs_credit_update_RPC'	=> '신고상벌',//'举报奖惩',
	'logs_credit_update_ACC'	=> '활동에 참가',//'参与活动',
	'logs_credit_update_RCT'	=> '답글 보상',//'回帖奖励',
	'logs_credit_update_RCA'	=> '답글 당첨',//'回帖中奖',
	'logs_credit_update_RCB'	=> '답글보상 포인트를 반환',//'返还回帖奖励积分',
	...
	'special_3_credit'		=> '포상 주제 포인트 차감',//'悬赏主题扣除积分',
	'special_3_best_answer'		=> '베시트 답글 포상포인트 획득',//'最佳答案获取悬赏积分',
	...
	'grade_credit'			=> '평점받아 얻은 포인트',//'被评分获得的积分',
	'grade_credit2'			=> '게시물 평가로 차감된 포인트',//'帖子评分扣除的积分',
	'thread_credit'			=> '주제로 얻은 포인트',//'主题获得积分',
	'thread_credit2'		=> '주제로 지출된 포인트',//'主题支出积分',
	'buy_credit'			=> '포인트 충전',//'对积分充值',
	'buy_usergroup'			=> '확장 사용자그룹 구매로 지출된 포인트',//'购买扩展用户组支出积分',
	...
	'profile_mypost'		=> '내가 제출한 내용',//'我提交的内容',
...
//vot	'district_level_0'		=> '- Country -',//'-国家-',
	...
	'follow_specified_group'	=> '방송전문구역',//'广播专区',
	'follow_specified_forum'	=> '방송전문포럼',//'广播专版',
	...
	'email_acitve_message'		=> '<img src="{imgdir}/mail_inactive.png" alt="미인증" class="vm" />
						...
						시스템은 이미 지정하신 메일주소로 메일주소인증용 메일을 발송하였으니 확인하시고 인증하시길 바랍니다.<br>
