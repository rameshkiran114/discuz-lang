...
(
	...
	'connect_setting_t_reply_comment'	=> 'Tencent미니블로그로 주제 푸시 혹은 공유 후 ',//'推送主题或分享主题到腾讯微博后，是否允许微博评论和转播内容回流',
	...
	'connect_member_bindlog'		=> 'QQ 바인딩 일지',//'QQ绑定日志',
	...
	'connect_member_bindlog_uin'		=> 'QQ계정 바인딩 일지',//'QQ帐号绑定日志',
	'connect_member_bindlog_uid'		=> '사용자계정 바인딩 일지',//'用户帐号绑定日志',
	...
	'qqgroup_msg_deficiency'	=> '최소 한개의 톱 주제 혹은 리스트주제를 푸시 해 주세요.',//'请至少推送一条头条主题和一条列表主题',
	...
	'qqgroup_search_order_replies'	=> '답글수 역순',//'回复数倒序',
	'qqgroup_search_order_heats'	=> '인기 역순',//'热度倒序',
	'qqgroup_search_order_dateline'	=> '발포 시간 역순',//'发布时间倒序',
	'qqgroup_search_order_lastpost'	=> '마지막 답글 역순',//'最后回复倒序',
	'qqgroup_search_order_recommends'	=> '주제 평가 역순',//'主题评价倒序',

	'qqgroup_search_dateline_1'	=> '1시간내 주제',//'1小时内发布的主题',
	'qqgroup_search_dateline_2'	=> '24시간내 주제',//'24小时内发布的主题',
	'qqgroup_search_dateline_3'	=> '7일내 주제',//'7天内发布的主题',
	'qqgroup_search_dateline_4'	=> '한달내 주제',//'1个月内发布的主题',
	'qqgroup_search_dateline_0'	=> '제한 없음',//'不限制',

	'qqgroup_search_tid'		=> '주제 ID:',//'主题ID:',
	'qqgroup_search_button'		=> '검색',//'搜索',
	'qqgroup_search_threadslist'	=> '주제리스트',//'主题列表',
	'qqgroup_search_inforum'	=> '소재 포럼판',//'所在版块',
	'qqgroup_search_operation'	=> '조작',//'操作',

	'qqgroup_search_loading'	=> '로딩중 ...',//'加载中...',
	'qqgroup_search_nothreads'	=> '지정 조건의 주제를 찾지 못했음. 기타 조건으로 재 검색 추천 합니다.',//'未找到指定条件的主题，请尝试更换筛选条件重新搜索',
	...
	'qqgroup_usergroup_feed_list'		=> '푸시가능한 사용자그룹',//'允许推送的用户组',
	'qqgroup_usergroup_feed_list_comment'	=> '선택한 사용자그룹은 푸시 권한이 있음 CTRL로 다량선택 가능. ',//'所选用户组拥有推送权限，可以按住 CTRL 多选',
	'qqgroup_setting_tips'			=> '<li>주제보기 페이이지의 "QQ그룹 푸시"기능은 게시글을 QQ그룹 채팅 박스로 실시간 푸시 가능.</li><li><img src="static/image/admincp/cloud/feed.png" align="left"></li>',//'<li>主题查看页的“推送到QQ群”功能，可将帖子即时推送到QQ群聊天框。</li><li><img src="static/image/admincp/cloud/feed.png" align="left"></li>',

	'security_member_list'		=> '반칙 사용자',//'违规用户',
	'security_thread_list'		=> '반칙 주제',//'违规主题',
	'security_post_list'		=> '반칙 답글',//'违规回帖',
	...
	'security_forum'		=> '포럼판',//'版块',
	'security_author'		=> '작성자/시간',//'作者/发帖时间',
	'security_view'			=> '보기',//'查看',
	'security_view_thread'		=> '주제 보기.',//'查看主题',
	...
	'recyclebin_search_security_thread'	=> '스팸보안에 처리된 주제만 포함.',//'仅包含防水墙处理的主题',
	'recyclebin_search_security_post'	=> '스팸보안에 처리된 답글만 포함.',//'仅包含防水墙处理的回帖',
	...
	'security_forum_white_list_comment'	=> '선택한 포럼판내의 주제 와 답글, 클라우드보안 진행 안합. CTRL로 다수 선택가능. ',//'所选版块内的主题和回复，防水墙不做处理，可以按住 CTRL 多选',
	'security_recyclebin_thread'		=> '휴지통으로 이동하여 테마 처리',//'到回收站处理主题',
	'security_recyclebin_post'		=> '휴지통으로 이동하여 답글 처리',//'到回收站处理回帖',
	'security_thread_status'		=> '테마상태',//'主题状态',
	'security_post_status'			=> '답글 상태',//'回帖状态',
	...
	'search_setting_allow_hot_topic'	=> '히트 주제 허용',//'开启热门话题',
	'search_setting_allow_forum_recommend'	=> '포럼판 추천 사 허용',//'开启板块推荐词',
	'search_setting_allow_thread_related'	=> '주제 관련 게시물 허용',//'开启主题相关帖',
	'search_setting_allow_forum_related'	=> '포럼판 관련 게시물 허용',//'开启板块相关帖',
	'search_setting_allow_collection_related'	=> '컬렉션 관련 게시물 허용',//'开启淘帖相关帖',
);
