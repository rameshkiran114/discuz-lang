...
(
	...
	'friend_request'	=> '{actor} 님이 친구 신청함{note}&nbsp;&nbsp;<a onclick="showWindow(this.id, this.href, \'get\', 0);" class="xw1" id="afr_{uid}" href="{url}">수락</a>',
	...
	'group_member_invite'	=> '{actor}님이 <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a>그룹으로 초대 합니다, <a href="{url}" target="_blank">가입하기</a>',//'{actor} 邀请你加入 <a href="forum.php?mod=group&fid={fid}" target="_blank">{groupname}</a> 群组，<a href="{url}" target="_blank">点此马上加入</a>',
	...
	'reason_merge'		=> '귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> {actor}님에 의해 {modaction} <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} {modaction} <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'reason_warn_post'	=> '귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>, {actor} {modaction} 님께 .<br />
	...
	'reason_move'		=> '귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 가 {actor}님에 의해  <a href="forum.php?mod=forumdisplay&fid={tofid}" target="_blank">{toname}</a>으로 이동 되였습니다. <div class="quote"><blockquote>{reason}</blockquote></div> ',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 移动到 <a href="forum.php?mod=forumdisplay&fid={tofid}" target="_blank">{toname}</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_copy'		=> '귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 가 {actor}님에 의해 <a href="forum.php?mod=viewthread&tid={threadid}" target="_blank">{subject}</a>으로 복사 되였습니다.<div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 复制为 <a href="forum.php?mod=viewthread&tid={threadid}" target="_blank">{subject}</a> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_remove_reward'	=> '귀하의 포상주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>가 {actor}님에 의해 취소 되였습니다. <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 撤销 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stamp_update'	=> '귀하의 주제<a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>가 {actor}님에 의해 도장{stamp} 이 추가되였습니다.<div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 添加了图章 {stamp} <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stamp_delete'	=> '귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>가 {actor}님에 의해 도장이 취소 되였습니다.<div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 撤销了图章 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stamplist_update'	=> '귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>가 {actor}님에 의해 아이콘 {stamp}이 추가 되였습니다.<div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 添加了图标 {stamp} <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stamplist_delete'	=> '귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>가 {actor}님에 의해 아이콘이 취소 되였습니다. <div class="quote"><blockquote>{reason}</blockquote></div>',//'你的主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 撤销了图标 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stickreply'		=> '주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>에서의 귀하의 답글이 {actor}님에 의해 베스트글로 설정 되였습니다. <div class="quote"><blockquote>{reason}</blockquote></div>',//'您在主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的回帖被 {actor} 置顶 <div class="quote"><blockquote>{reason}</blockquote></div>',

	'reason_stickdeletereply'	=> '주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>에서의 귀하의 답글이 {actor}님에 의해 베스트글 취소 되였습니다. <div class="quote"><blockquote>{reason}</blockquote></div>',//'你在主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的回帖被 {actor} 撤销置顶 <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'modthreads_delete'	=> '귀하가 발포하신 주제 {threadsubject}가 심사에 통과 되지 못했고 이미 삭제 되였습니다, <div class="quote"><blockquote>{reason}</blockquote></div>',//'你发表的主题 {threadsubject} 没有通过审核，现已被删除！<div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'modreplies_delete'	=> '귀하의 답글이 심사에 통과 되지 못했으며 이미 삭제 되였습니다. <p class="summary">답글 내용: <span>{post}</span></p> <div class="quote"><blockquote>{reason}</blockquote></div>',//'你发表回复没有通过审核，现已被删除！ <p class="summary">回复内容：<span>{post}</span></p> <div class="quote"><blockquote>{reason}</blockquote></div>',

	'modreplies_validate'	=> '귀하의 답글이 심사에 통과 되였습니다. &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">보기</a> <p class="summary">답글 내용: <span>{post}</span></p> <div class="quote"><blockquote>{reason}</blockquote></div>',//'你发表的回复已经审核通过！ &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看 &rsaquo;</a> <p class="summary">回复内容：<span>{post}</span></p> <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'rate_reason'		=> ' 귀하의 주제 <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a>가 {actor}님에 의해 [{ratescore}] 평점 되였습니다. <div class="quote"><blockquote>{reason}</blockquote></div>',//'你在主题 <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a> 的帖子被 {actor} 评分 {ratescore} <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'rate_removereason'	=> '{actor}님께서 주제<a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a>에서의 귀하의 게시글평점을 취소 하셨습니다. {ratescore} <div class="quote"><blockquote>{reason}</blockquote></div>',//'{actor} 撤销了你在主题 <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">{subject}</a> 中帖子的评分 {ratescore} <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'activity_cancel'	=> '{actor}님께서 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 이벤트 참가 취소를 하셨습니다. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}"  target="_blank" class="lit">보기 &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',//'{actor} 取消了参加 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 活动 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}"  target="_blank" class="lit">查看 &rsaquo;</a> <div class="quote"><blockquote>{reason}</blockquote></div>',
	...
	'reward_question'	=> '귀하의 포상주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 에 {actor}님이 최적 답을 설정 하셨습니다. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">보기</a>',//'你的悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 被 {actor} 设置了最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'reward_bestanswer'	=> '귀하의 답글이 포상주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 의 작성자{actor}님께서 최적 답으로 선정 하셨습니다. &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">보기</a>',//'你的回复被的悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的作者 {actor} 选为悬赏最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'reward_bestanswer_moderator'	=> '포상주제 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 에서의 귀하의 답글이 최적 답으로 선정되였습니다.&nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">보기 &rsaquo;</a>',//'您在悬赏主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 的回复被选为最佳答案 &nbsp; <a href="forum.php?mod=viewthread&tid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'comment_add'		=> '{actor}님이 귀하가 주제<a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a>에서의 게시글을 평가 하셨습니다. &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">보기</a>',//'{actor} 点评了您曾经在主题 <a href="forum.php?mod=viewthread&tid={tid}" target="_blank">{subject}</a> 发表的帖子 &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看 &rsaquo;</a>',

	'reppost_noticeauthor'	=> '{actor}님이 답글 하셨습니다. <a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">{subject}</a>. &nbsp; <a class="lit" href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank">보기</a>',//'{actor} 回复了您的帖子 <a href="forum.php?mod=redirect&goto=findpost&ptid={tid}&pid={pid}" target="_blank">{subject}</a> &nbsp; <a href="forum.php?mod=redirect&goto=findpost&pid={pid}&ptid={tid}" target="_blank" class="lit">查看</a>',
	...
	'member_follow_add'		=> '{actor} 님이 팔로잉 하셨습니다. <a href="home.php?mod=follow&do=follower">Click to view</a>',//'{actor} 收听了你。<a href="home.php?mod=follow&do=follower">Click to view</a>',
	...
	'member_moderate_validate'	=> '귀하의 계정이 심사에 통과 되였습니다.<br />관리자 알림: <b>{remark}</b>',//'你的账号已经通过审核。<br />管理员留言: <b>{remark}</b>',
	...
	'manage_verifythread'		=> '심사대기중인 주제가 있습니다. <a href="admin.php?action=moderate&operation=threads&dateline=all">Verify now</a>',//'有新的待审核主题。<a href="admin.php?action=moderate&operation=threads&dateline=all">现在进行审核</a>',//'有新的待审核主题。<a href="admin.php?action=moderate&operation=threads&dateline=all">现在进行审核</a>',//'有新的待审核主题。<a href="admin.php?action=moderate&operation=threads&dateline=all">现在进行审核</a>',
	'manage_verifypost'		=> '심사대기중인 답글이 있습니다. <a href="admin.php?action=moderate&operation=replies&dateline=all">Verify now</a>',//'有新的待审核回帖。<a href="admin.php?action=moderate&operation=replies&dateline=all">现在进行审核</a>',
	...
	'manage_verifyblog'		=> '심사대기중인 일지가 있습니다. <a href="admin.php?action=moderate&operation=blogs">Verify now</a>',//'有新的待审核日志。<a href="admin.php?action=moderate&operation=blogs">现在进行审核</a>',
	...
	'manage_verifycommontes'	=> '심사대기중인 새로운 메모/답글이 있습니다. <a href="admin.php?action=moderate&operation=comments">Verify now</a>',//'有新的待审核留言/评论。<a href="admin.php?action=moderate&operation=comments">现在进行审核</a>',
	'manage_verifyrecycle'		=> '휴지통에 처리 대기중인 새로운 주제가 있습니다. <a href="admin.php?action=recyclebin">보기</a>',//'回收站有新的待处理主题。<a href="admin.php?action=recyclebin">现在处理</a>',
	...
	'manage_verifyacommont'		=> '새로운 문서코멘트 심사 대기가 있습니다. <a href="admin.php?action=moderate&operation=articlecomments">보기</a>',//'有新的待审核文章评论。<a href="admin.php?action=moderate&operation=articlecomments">现在进行审核</a>',
	'manage_verifytopiccommont'	=> '새로운 토픽코멘트 심사 대기가 있습니다. <a href="admin.php?action=moderate&operation=topiccomments">보기</a>',//'有新的待审核专题评论。<a href="admin.php?action=moderate&operation=topiccomments">现在进行审核</a>',
	...
	'invite_collection'		=> '{actor}님께서 귀하를 컬렉션 앨범:<a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> work team.<br /><a href="forum.php?mod=collection&action=edit&op=acceptinvite&ctid={ctid}&dateline={dateline}">Accept the invitation</a> 의 공동편집에 초대 하셨습니다.',//'{actor} 邀请您参与维护淘专辑  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a>。<br /> <a href="forum.php?mod=collection&action=edit&op=acceptinvite&ctid={ctid}&dateline={dateline}">接受邀请</a>',
	'collection_removed'		=> '편집에 참가하신 컬렉션 앨범 <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 은 {actor}님께의해 닫겼습니다.',//'您参与维护的淘专辑  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 已被 {actor} 关闭。',
	'exit_collection'		=> '컬렉션 앨범 <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 의 편집에서 퇴출 하셨습니다.',//'您已经退出维护淘专辑  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a>。',
	'collection_becommented'	=> '귀하의 컬렉션 앨범 <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 에 새로운 코멘트가 있습니다.',//'您的淘专辑  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 收到了新评论。',
	'collection_befollowed'		=> '귀하의 컬렉션 앨범 <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 이 새로운 구독자가 있습니다.',//'您的淘专辑  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 有新用户订阅了！',
	'collection_becollected'	=> '축하합니다,귀하의 주제 <a href="forum.php?mod=viewthread&tid={tid}">{threadname}</a> 가 <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a>컬렉션에 수록 되였습니다. !',//'恭喜您的主题 <a href="forum.php?mod=viewthread&tid={tid}">{threadname}</a> 被淘专辑  <a href="forum.php?mod=collection&action=view&ctid={ctid}">{collectionname}</a> 收录了！',
