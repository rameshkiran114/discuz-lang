...
$lang = array(
	...
	'album_li' => '<li style="width:70px"><div class="c"><a href="home.php?mod=space&uid={uid}&do=album&id={albumid}" target="_blank" title="{albumname}, อัพเดท {date}"><img src="{src}" alt="{albumname}" width="70" height="70" /></a></div><p><a href="home.php?mod=space&uid={uid}&do=album&id={albumid}" target="_blank" title="{albumname}, อัพเดท {date}">{albumname}</a></p><span>จำนวนรูปภาพ: {picnum}</span></li>',
	...
	'block_doing_no_content_publish' => ', <a href ="home.php?mod=space&uid={uid}&do=doing&view=me&from=space">อัพเดทข้อความทักทาย</a>',
	...
	'block_feed_no_content' => 'ไม่มีรายการอัพเดท',
	...
	'block_myapp_no_content' => 'ไม่มีแอพพลิเคชัน',
	'block_myapp_no_content_publish' => ', <a href ="userapp.php?mod=manage&my_suffix=/app/list">ฉันต้องการเล่นแอพพลิเคชัน</a>',
