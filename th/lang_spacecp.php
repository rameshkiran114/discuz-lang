...
$lang = array(
	...
	'space_update' => '{actor} อัพเดทโปรไฟล์ส่วนตัว',

	'active_email_subject' => 'เปิดใช้งานอีเมล์ของคุณ',
	'active_email_msg' => 'กรุณาคัดลอกลิงก์เปิดใช้งานต่อไปนี้ลงในเบราว์เซอร์ เพื่อเปิดการใช้งานอีเมล์ของคุณ<br>ลิงก์สำหรับเปิดใช้งานอีเมล์:<br><a href="{url}" target="_blank">{url}</a>',
	...
	'upload_album' => 'อัลบั้มอัพเดทล่าสุด',
	'the_total_picture' => 'ทั้งหมด \\1 รูปภาพ',

	'space_open_subject' => 'แจ้งเตือน ให้ดูแลและอัพเดทโปรไฟล์ส่วนตัวของคุณ',
	'space_open_message' => 'สวัสดี วันนี้ฉันได้ไปเยี่ยมชมโปรไฟล์ส่วนตัวของคุณ พบว่าคุณไม่ดูแลโปรไฟล์ของตัวเอง คุณน่าจะไปดูแลและอัพเดทโปรไฟล์ของคุณบ้าง โปรไฟล์ของคุณคือ:\\1space.php',
	...
	'do_stat_appinvite' => 'เชิญให้เข้าร่วมแอปพลิเคชัน',
	'do_stat_add' => 'เผยแพร่',
...
//'district_level_0'		=> '- Country -',//'-国家-',
	...
	'card_update_doing' => ' <a class="xi2" href="###">[อัพเดทข้อความทักทาย]</a>',
	'email_acitve_message' => '<img src="{imgdir}/mail_inactive.png" alt="ยังไม่ได้ยืนยัน" class="vm" />
					<span class="xi1">อีเมล์({newemail})ของคุณยังไม่ได้ยืนยัน...</span><br />
						ระบบได้ส่งอีเมล์ยืนยันไปยังอีเมล์ที่คุณใช้ลงทะเบียน โปรดตรวจสอบอีเมล์ของคุณ เพื่อยืนยันและเปิดใช้งาน<br>
						ถ้าคุณไม่ได้รับอีเมล์ยืนยัน คุณสามารถเปลี่ยนอีเมล์ หรือ<a href="home.php?mod=spacecp&ac=profile&op=password&resend=1" class="xi2">คลิกที่นี่เพื่อขอรับอีเมล์ยืนยันอีกครั้ง</a>',
