...
(
	...
	'float_disableclose_comment'	 => 'If the ad code has built-in shut down the operating, disable the link to close the System Preferences',//'如果广告代码中已内置关闭操作，可以关闭系统预置的关闭链接',
	'float_show'			 => 'Show',//'显示',
