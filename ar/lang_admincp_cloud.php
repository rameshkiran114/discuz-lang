...
(
	...
	'cloud_doctor_setidkey_tips'	=> '<li style="color:red">اي خطأ في التغيير سوف يسبب اخطاء في الاتصال, لذلك لا تنسى قراءة نصائح الموقع الرسمي</li><li style="color:red">قبل تعديل رقم الموقع, ومفتاحه,  اعمل نسخة احتياطية من الجدول التالي  forum common_setting لتجنب الاخطاء.</li>',//'<li style="color:red">修改Discuz!上的站点ID和KEY，可能会导致通信错误、签名错误以及其他的故障，请勿在没有官方人员指导的情况下修改。</li><li style="color:red">修改ID、KEY和状态前，请先备份论坛的common_setting表。</li>',
