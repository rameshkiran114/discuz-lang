...
$lang = array
(
	'namepost_name'			=> 'بطاقة مرئية',
	'namepost_desc'			=> 'يمكنك جعل مشاركات المجهول مرئية',
	'namepost_forum'		=> 'المنتديات المسموحة',
	'namepost_num'			=> 'Has a number: {magicnum}',//'拥有个数: {magicnum}',
	'namepost_info'			=> 'مشاركات محددة, قم بإدخال ارقام المشاركات',
	'namepost_info_nonexistence'	=> 'الرجاء تحديد المشاركات',
	'namepost_succeed'		=> 'تمت العملية بنجاح',//'匿名的用户是 <a title="{username}" href="space.php?uid={uid}" target="_blank"><b>{username}</b></a>',
