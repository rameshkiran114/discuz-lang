...
//static/js/forum_post.js
	...
	'delete_post_sure'	: 'Уверены, что надо удалить данный пост?',//'确定要删除该帖子吗？',
	'feed_add_confirm'	: 'Постинг имеет специальные права доступа или платный, Вы уверены, что следует сгенерировать новостную запись для Ваших подписчиков?',//'由于您设置了阅读权限或出售帖，您确认还转播给您的听众看吗？',
//--------------------------------
